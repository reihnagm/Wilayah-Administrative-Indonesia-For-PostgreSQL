...
<head>
    ...
    <link rel="shortcut icon" href="/favicon.ico?ver=41400"/>

    <!-- Base template stylesheets -->
    <link type="text/css" rel="stylesheet" href="/static/js/generated/style.css?ver=41400"/>
    <link type="text/css" rel="stylesheet" href="/static/js/generated/pgadmin.css?ver=41400"/>

     <!--View specified stylesheets-->
    <link type="text/css" rel="stylesheet" href="/browser/browser.css?ver=41400"/>
    ...
    <script type="text/javascript"
            src="/static/vendor/require/require.min.js?ver=41400"></script>
    <script type="text/javascript">
            require.config({
                baseUrl: '',
                urlArgs: 'ver=41400',
    ...
    <script type="text/javascript" src="/static/js/generated/vendor.main.js?ver=41400" ></script>
    <script type="text/javascript" src="/static/js/generated/vendor.others.js?ver=41400" ></script>
    <script type="text/javascript" src="/static/js/generated/pgadmin_commons.js?ver=41400" ></script>
...
<div id="pg-spinner" class="pg-sp-container">
  <div class="pg-sp-content">
    ...
    <div class="row"><div class="col-12 pg-sp-text">Loading pgAdmin 4 v4.14...</div></div>
  </div>
</div>
    ...
    <div class="collapse navbar-collapse" id="navbar-menu" role="navigation">
        ...
        <ul class="navbar-nav mr-auto">
            <li id="mnu_file" class="nav-item active dropdown d-none">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">File <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu"></ul>
            </li>
            <li id="mnu_edit" class="nav-item active dropdown d-none">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Edit <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu"></ul>
            </li>
            <li id="mnu_obj" class="nav-item active dropdown ">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Object <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu"></ul>
            </li>
            <li id="mnu_management" class="nav-item active dropdown d-none">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Management <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu"></ul>
            </li>
            <li id="mnu_tools" class="nav-item active dropdown d-none">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Tools <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu"></ul>
            </li>
            <li id="mnu_help" class="nav-item active dropdown d-none">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Help <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu"></ul>
            </li>
        </ul>
            </div>
